    ...
    >
      ...
      <Box sx={{ marginTop: 5 }}>
        ...
        <Typography variant="body1">
          ...
          use of the https:.//cryxnet.com website as well as any other media
          ...
          Leach-Bliley Act (GLBA) The Site is intended for users who are at
      ...
      <Box sx={{ marginTop: 5 }}>
        ...
        <Typography variant="body1">
          ...
          limited license to access and use the Site and to downioad or print a
      ...
      <Box sx={{ marginTop: 5 }}>
        ...
        <Typography variant="body1">
          ...
          unauthorized framing of or linking to the Site. - Upload or transmit
          ...
          and extraction tools. - Delete the copyright or other proprietary
          ...
          referred to as "spyware" or - Engage in any automated use of the
          ...
          portion of the Site - Copy or adapt the Site's software, including but
          not limited to Flash, PHP., HTML, JavaScript, or other code. - Except
          ...
          up a part of the Site • Except as may be the result of standard search
      ...
      <Box sx={{ marginTop: 5 }}>
        ...
        <Typography variant="body1">
          ...
          in violation of the foregoing violates these Terms of Use and may
      ...
      <Box sx={{ marginTop: 5 }}>
        ...
        <Typography variant="body1">
          ...
          Site is hosted in . If you access the Site from any other region of
          ...
          data to and you agree to have your data transferred to and processed
          in Further. we do not knowingly accept, request, or solicit
      ...
      <Box sx={{ marginTop: 5 }}>
        ...
        <Typography variant="body1">
          ...
          provisions of the law of your country of residence. and yourself both
          ...
          protection rights in regards to these Terms of Use in Switzerland, or
      ...
      <Box sx={{ marginTop: 5 }}>
        ...
        <Typography variant="body1">
          ...
          ALL OF THE ABOVE DISCLAIMERS OR LIMITATIONS MAY NOT APPI Y TO YOU AND
